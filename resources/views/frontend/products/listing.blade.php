...
?>
                    ...
                    <ul class="ps-list--categories">
                        ...
                        <li class="current-menu-item menu-item-has-children"><a href="{{$section->name}}">{{$section->name}}</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                            <ul class="sub-menu">
                                @foreach($section->categories as $category)
                                <li class="current-menu-item "><a href="{{ $category->name }}">{{$category->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </li>
            ...
            <div class="ps-layout__right">
                <div class="ps-shopping ps-tab-root">
                    <div class="ps-shopping__header">
                        <p><strong> {{$categoryProductsCount}}</strong> Products found</p>
                                        ...
                                        <div class="ps-product">
                                            ...
                                            <div class="ps-product__container"><a class="ps-product__vendor" href="#">ROBERT’S STORE</a>
                                                ...
                                                <div class="ps-product__content hover"><a class="ps-product__title" href="product-default.html">{{$product['name']}}</a>
                                                    <p class="ps-product__price">${{$product['price']}}</p>
                                                    <p class="ps-product__price">{{$product['brand']['name']}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="ps-product ps-product--wide">
                                    ...
                                    <div class="ps-product__container">
                                        ...
                                        <div class="ps-product__shopping">
                                            <p class="ps-product__price">${{$product['price']}}</p><a class="ps-btn" href="#">Add to cart</a>
                                            <ul class="ps-product__actions">
