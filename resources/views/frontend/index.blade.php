...
<div id="homepage-1">
    <div class="ps-home-banner ps-home-banner--1">
        <div class="ps-container">
            ...
            <div class="ps-section__right"><a class="ps-collection" href="#"><img src="{{asset('frontend/img/slider/home-1/promotion-1.jpg')}}" alt=""></a><a class="ps-collection" href="#"><img src="{{asset('frontend/img/slider/home-1/promotion-2.jpg')}}" alt=""></a></div>
        </div>
    </div>
                    ...
                    <div class="ps-product ps-product--inner">
                        ...
                        <div class="ps-product__container">
                            ...
                            <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Aroma Rice Cooker</a>
                                ...
                                <div class="ps-product__progress-bar ps-progress" data-value="21">
                                    <div class="ps-progress__value"><span></span></div>
                                    <p>Sold:67</p>
                                </div>
                            </div>
                    ...
                    <div class="ps-product ps-product--inner">
                        ...
                        <div class="ps-product__container">
                            ...
                            <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Letter Printed Cushion Cover Cotton</a>
                                ...
                                <div class="ps-product__progress-bar ps-progress" data-value="20">
                                    <div class="ps-progress__value"><span></span></div>
                                    <p>Sold:22</p>
                                </div>
                            </div>
                    ...
                    <div class="ps-product ps-product--inner">
                        ...
                        <div class="ps-product__container">
                            ...
                            <div class="ps-product__content"><a class="ps-product__title" href="product-default.html">Letter Printed Cushion Cover Cotton</a>
                                ...
                                <div class="ps-product__progress-bar ps-progress" data-value="76">
                                    <div class="ps-progress__value"><span></span></div>
                                    <p>Sold:72</p>
                                </div>
                            </div>
        ...
        <div class="ps-container">
            ...
            <div class="ps-section__content">
                <div class="ps-carousel--nav owl-slider" data-owl-auto="false" data-owl-loop="false" data-owl-speed="10000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="7" data-owl-item-xs="2" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
                    ...
                    <div class="ps-product">
                        <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/electronic/9.jpg')}}" alt=""></a>
                            <ul class="ps-product__actions">
                                <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
                    ...
                    <div class="ps-product">
                        <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/electronic/10.jpg')}}" alt=""></a>
                            <ul class="ps-product__actions">
                                <li><a href="#" data-toggle="tooltip" data-placement="top" title="Read More"><i class="icon-bag2"></i></a></li>
                                <li><a href="#" data-placement="top" title="Quick View" data-toggle="modal" data-target="#product-quickview"><i class="icon-eye"></i></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="top" title="Add to Whishlist"><i class="icon-heart"></i></a></li>
