...
?>
                    ...
                    <ul class="ps-list--categories">
                        ...
                        <li class="current-menu-item menu-item-has-children"><a href="shop-default.html">{{$section->name}}</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
                            <ul class="sub-menu">
                                @foreach($section->categories as $category)
                                <li class="current-menu-item "><a href="shop-default.html">{{$category->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </li>
            ...
            <div class="ps-layout__right">
                <div class="ps-shopping ps-tab-root">
                    <div class="ps-shopping__header">
                        <p><strong> {{$featuredProductsCount}}</strong> Products found</p>
                    ...
                    <div class="ps-tabs">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 ">
                                        <div class="ps-product">
                                            <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/1.jpg')}}" alt=""></a>
                        ...
                        <div class="ps-tab" id="tab-2">
                            <div class="ps-shopping-product">
                                ...
                                <div class="ps-product ps-product--wide">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/3.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="ps-product__container">
                                ...
                                <div class="ps-product ps-product--wide">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/10.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="ps-product__container">
                                ...
                                <div class="ps-product ps-product--wide">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{asset('frontend/img/products/shop/11.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="ps-product__container">
